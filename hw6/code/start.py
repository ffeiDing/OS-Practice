...
def start_etcd(ip_addr):
    ...
    '--initial-cluster', 'node0=http://192.168.4.100:2380,node1=http://192.168.4.101:2380,node2=http://192.168.4.102:2380,node3=http://192.168.4.103:2380,node4=http://192.168.4.104:2380', \
    '--initial-cluster-state', 'new']
    subprocess.Popen(args)

def host_list(ip_addr):
